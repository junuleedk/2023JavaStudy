...
class FruitBuyer3 {
	...
	public FruitBuyer3(int i, int j) {
...
public class E06FruitSalesMain3 {
	...
	public static void main(String[] args) {
		/*
		 생성자를 사용해서 인스턴스를 생성하면 아래와 같이 생성과 동시에 초기화까지 할수 있다.
		 따라서 초기화 메서드를 사용하는 것보다 적은 코드로 작성할 수 있는 장점이 있따. 
		 */
		FruitSeller3 seller1 = new FruitSeller3(0, 100, 1000);//인스턴스가 만들어지고 초기화까지 함
