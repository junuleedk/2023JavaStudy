...
/*
 ...
 -매개변수의 갯수가 다르거나 자료형이 다를 때 성립힌다.
 -반환 타입만 다른 것은 허용하지 않는다.
 -컴파일러는 매서드 호출시 전달되는 인수를 통해 호출할 메서드를 구분한다. 
 */
public class E07Overloading {
	...
	/*
	 * 해당 메서드는 앞에서 선언한 것과 반환타입만 다른 경우이므로 person(10)으로 호출한다 가정했을 때 어떤 메서드를 호출할지 애매하므로
	 * 에러가 발생한다. 따라서 아래의 메서드는 오버로딩이 성립하지 않는다.
	 */
...
//	}
	...
	public static void main(String[] args) {
		...
		/*
		 * 출력을 위해 사용하는 print()가 대표적인 오버로딩으로 정의된 메서드이다. 정수, 실수 문자 등 모든 타입에 대해 출력할 수 있도록
		 * 정의되어있다.
		 */
