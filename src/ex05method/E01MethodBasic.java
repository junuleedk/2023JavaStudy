...
public class E01MethodBasic {
		...
		/*
		 메서드2: 반환값X, 매개변수X 형태
		 => 전달 받는값 없이 이름을 입력 받은 후 namePrint()를 호출한다.
		...
		/*
		 ...
		 없는 경우에는 실행이 종료되며 호출했던 지점으로 실행의 흐름이 이동된다.
		 */
		...
		{	
			...
			System.out.println("1과 2를 전달 한 결과: " + result);
			System.out.println("10과 20을 전달 한 결과: " + simpleFunc(10, 20));
