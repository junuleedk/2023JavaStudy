...
/*
 for문 
 : while문과 같은 반복문으로 초기값, 조건식, 증감식이 한줄에 있어 반복의 횟수를 명확히 알수 있는 반복문이다.
...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		 시나리오] 1 ~ 100 까지의 합을 구하는 프로그램을 for문을 이용하여 작성하시오
		 */
		//누적합 저장용 변수
		int sum = 0;
...
//			}  System.out.println();
//		}
		System.out.println("for문을 이용한 0과 1패턴 출력하기");
		for(int x = 1; x <= 4; x++) {
			for(int y = 1; y <= 4; y++) {
				/*
				 x와 y의 합이 5일때만 1을 출력, 실행할 문장이 1개이므로 중괄호 생략가능
				 */
				if(x + y == 5) {
					System.out.print("1 ");
				}
