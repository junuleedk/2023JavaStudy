...
※ 만약 break문이 없으면 그 아래의 모든 실행문이 실행하게 된다.        	 
 */
public class E02Switch {
	...
	public static void main(String[] args) {
		/*
		 Scanner클래스
		 : 사용자로부터 입력값을 받기 위한 클래스로, 해당 클래스의 메서드가 실행되면 잠깐 실행이 중지되고 입력을 기다린다.
		 nextLine() : 문자열을 입력받는다.
		 nextInt() : 정수를 입력받는다.
		 */
		...
		default:
			...
			//default 다음에는 실행할 문장이 없으므로 break를 쓰지 않는다.
		}
...
//	    }
	    ...
	    /*
	     여러case를 동시에 처리할 때는 break문 없이 case를 나열하면 된다. 
