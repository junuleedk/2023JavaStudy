...
/*
 ...
 Exception클래스는 모든 예외를 처리할 수 있으므로 반드시 마지막 블럭에
 작성해야한다.
 */
public class Ex04MultiCatch {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i = 0; i < array.length; i++) {
				/*
				 ...
				 만약 숫자형식이 아닌 "1a와 같이 입력하면 정수로 변경할 수 없어
				 예외가 발생한다. 
				 */
			...
			/*
			 두번째 숫자로 0을 입력하면 나눗셈 연산이 불가능해지믕로 예외가 발생된다. 
			 */
			...
			/*배열의 크기가 3이므로 인덱스는 2까지만 존대한다. 따라서
			  여기에서도 예외가 발생한다.*/
			array[3] = age;
		}
			...
			/*
			 ...
			 마지막에 기술해야한다. 위쪽으로 이동시리면 에러가 발생하게 된다.
		...
		/*
		 ...
		 정상적으로 종료된다. 이처럼 실행의 흐름이 마지막까지 이어지게 하는 것이 '예외처리"의 목적이다.
		 */
