...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		 ...
		 */
		int num1 = 10, num2 = 20;
		String numResult = (num1 == num2) ? "데이터같다" : "데이터가다르다";
		...
		/*
		 ...
		 2개의 인스턴스는 따로 생서오디므로 다르다는 결과가 출력된다. 
		 */
		if(str1 == str2) {
		...
		/* equals()메서드 : Object 클래스로부터 상속받은 메서드로 
		 * 실제 저장된 문자열의 내용을 비교하도록 정의되어있다.
		...
		/*
		 ...
		 즉, 새로운 메모리를 할당하지 않는다. 
		 따라서 String인스턴스는 주로 방법2를 통해 생성하는 것이 좋다. 
		 */
		String str3 = "자바개발자";
		String str4 = "자바개발자";
