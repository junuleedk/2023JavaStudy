	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 ...
		 -int형보다 작은 자료형을 연산하면 CPU int형으로 변환하여 계산한다.
		...
		/*
		 ...
		 이때 접미사(L 혹은 l)을 붙여서 int형의 자료가 아닌 long형의 자료임을 컴파일러에게 알려줘야한다. 이와 같이 할당을 위한
		 입력되는 숫자도 자료형을 기반으로 메모리에 로드되는데 이를 가르켜 리터럴(literal)이라고 한다.
		 */
