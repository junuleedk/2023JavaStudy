...
/*
 ...
 가져다 쓰기 위한 선언으로, 사용할 클래스의 위치를 지정하는 것으로 생각하면된다.
 */
...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 클래스명으로 직접 메서드를 호출할 수 있다. Java에서 제공하는 클래스 중 대표적으로 Math를 예로
		 들수 있다. 난수생성을 위해 별도의 인스턴스 생성없이 Math.random()을 호출하여 난수를 생성한다.
		 */
