...
/*
 ...
 : 기존에 정의된 클래스에 메서드와 변수를 추가하여 새로운 클래스를 정의하는 것을 말한다.
   부모클래스를 자식클래스가 상속할 때는 extends키워드를 사용한다.
 */
...
class Man {
	...
	//생성자는 오버로딩으로 2개를 정의한다. (호출여보는 print를 통해 확인)
	public Man() {
	...
	/*
	 멤버메서드에서는 private멤버라도 동일 클래스 내부이므로 접근이 가능하다. 
	 */
...
class BusinessMan extends Man {
	...
	/*
	 ...
	 super()는 부모클래스의 생성자를 호출하는 역할을 한다. 만약 super()를 기술하지 않으면
	 컴파일러에 의해 자동으로 삽입되어 디폴트 생성자가 호출된다.
	 */
