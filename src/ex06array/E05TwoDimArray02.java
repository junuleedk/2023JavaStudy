...
public class E05TwoDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 배열명[인덱스 n].length => 배열의 열 크기를 반환한다. 
		 */
		 ...
		 * 1. 2차원 배열을 선언하다. 세로 
		 * 2. 기로 4 2. 난수를 이용하여 배열을 초기화한다. (0 ~ 100사이) 
		...
		/*
		 초기화 전, 후 두 번의 출력을 해야하므로 코드의 중복을 제거하기 위해 출력용 메서드를 정의한 후 
		 필요할 때 호출하여 사용한다. 
		 */
	...
	//2차원 배열의 참조값을 매개변수로 전달 받아 전체 원소를 출력한다. 
	...
	/*매개변수로 전달된 정수만큼 2차원 배열의 전체원소를 증가시킨다. 이를 위해 복합대입연산자를 사용하고 있다.*/
