	...
	public static void main(String[] args) {
		/*
		 ...
		 : Math클래스의 random() 메서드는 0~1사이의 실수를 랜덤하게 반환해준다. 
		   정수형태의 난수가 필요한 경우네는 10이나 100과 같은 정수를 곱해주면된다.
		 */
		...
		/*
		 난수생성방법2
		 : Random클래스를 사용한다. 사용법은 Scanner와 동일하게 정수형 난수를 생성하고 싶다면 nextInt()를 호출한다.
		 */
		...
		/*
		 ...
		 3. 0은 구간에 포함되지 않으므로 결과를 1을 더해준다.
