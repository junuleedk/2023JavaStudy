...
class MyString implements Comparable<MyString> {
	...
	/*
	 TreeSet<T>에 인스턴스를 저장할 때 정렬을 위해 compareTo()를
	 오버라이딩한다.
	 정렬의 기준은 단순히" 가나다라"와 같은 순서가 될 수 있고, 문자열의 길이에따른
	 정렬이 될수도 있다. 
...
public class Ex05TreeSetMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("저장된데이터수: " + tree1.size() + "개");
		...
		tree2.add(new MyString("JavaWwb"));
