...
/*
 => 기존 Object 기반의 FruitBox를 아래와 같이 제네릭 클래스로 변경한다.
 	자료형에 해당하는 부분을 타입매개변수로 교체하고 인스턴스 생성시 자료형을 결정하기
 	위해 클래스명 <T> 형태로 변경한다.
 */
...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 각각 Apple, Banana 인스턴스를 저장할 수 있는 상자 인스턴스가 생성되었다. 
		 */
		...
		/*
		 OrangeBox는 인스턴스 생서이 Orange를 저장할 수 있는 용도로 생성되었기 때문에 다른 객체는 아예 저장할 수 없다. 
