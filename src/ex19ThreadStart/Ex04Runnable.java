...
class Sum {
	...
	/*메서드 호출시 전달되는 인수으 ㅣ값을 누적해서 멤버변수에 더한다.
...
class AdderThread extends Sum implements Runnable {
	...
	/*
	 ...
	 호출하여 누적합을 구한다. start가 1이고 end가 10이라면 1 ~ 10까지의 합을 
	 쓰레드를 통해 계산하게 된다. 
	 */
	@Override
	public void run() {
...
public class Ex04Runnable {
	...
	public static void main(String[] args) {
		/*
		 ...
		 쓰레드를 생성한다. 해당 방법도 결국 Thread 클래스를 통해서 쓰레드를 생성하게 된다. 
		 */
